...
$columns = "select * ";
$sql = " from synergy_static_pages2 where 1 ";
...
?>   
		...
		<tr class="<?php echo $css?>">
            ...
            <td align="center" nowrap>              <!--<a href="categories_details.php?cat_id=<?php echo $user_id?>">Details</a> | -->    <a href="add_page2.php?PageId=<?php echo $page_id;?>">Edit</a> </td>
            </tr>
