...
$cmsimp="select * from imp_static_pages where page_id='6'";
...
<div class="inner_bg">
<div class="header"><img src="images/aboutus_top_line.jpg" /><br /><div class="middle_top"><a href="index.php">Home</a> >> <a href="outsourcingservices.php"><?php echo $CmsRow['page_name'];?></a></div>
