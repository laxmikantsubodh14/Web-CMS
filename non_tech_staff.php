...
$cmsimp="select * from imp_static_pages where page_id='7'";
...
<div class="inner_bg">
<div class="header"><img src="images/aboutus_top_line.jpg" /><br /><div class="middle_top"><a href="index.php">Home</a> >> <a href="non_tech_staff.php"><?php echo $CmsRow['page_name'];?></a></div>
