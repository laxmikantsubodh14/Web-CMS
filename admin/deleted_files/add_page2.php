...
if($_POST['flag']=="yes")
{
		...
		if($page_id!='') 
		{
			...
			$sqlUpdate="update synergy_static_pages2 set page_name='$page_name',page_description='".addslashes(stripslashes($page_description))."',
			...
			?>
				...
				location.href="static_home_list2.php";
				</script>
				<?php 
...
if(isset($PageId))
{
	$sqlPage="select * from synergy_static_pages2 where page_id='".$PageId."'";
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
              ...
              <TR>
                ...
                <TD class=blueheading align=left width="56%">Static Page Manager</TD>
					<td width="41%" align="right"><a href="static_home_list2.php">
          ...
          <TD vAlign=top align=middle bgColor=#ffffff>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
				...
				<form name="form1" method="post" action="<?php echo $PHP_SELF;?>" onSubmit="return valid_page('form1');">
				...
				<tr class="oddClass">
				  ...
				  <td width="79%"><input name="page_name" type="text" class="textbox12" value="<?php echo $page_name;?>"></td></tr>
				<tr class="evanClass">
