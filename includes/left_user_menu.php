...
<div class="left_menu">
  <div class="left_menu_left"><img src="images/services_icon1.jpg" class="left_image" hspace="5" align="baseline" />User Home</div>
  <div class="aboutus_content_line"><br /><div class="aboutus_content_line1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow1.jpg" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="memberhome.php">User Home</a></div>
<div class="about_line"><img src="images/about_line.jpg" /></div>

<div class="aboutus_content_line1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow1.jpg" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="uservideo.php">User Videos</a></div>
<div class="about_line"><img src="images/about_line.jpg" /></div>

<div class="aboutus_content_line1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow1.jpg" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="userfile.php">User Files</a></div>
<div class="about_line"><img src="images/about_line.jpg" /></div>

<div class="aboutus_content_line1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow1.jpg" />&nbsp;&nbsp;&nbsp;&nbsp;<a href="editprofile.php">View Profile</a></div>
<div class="about_line"><img src="images/about_line.jpg" /></div>

<div class="aboutus_content_line1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow1.jpg" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="changepassword.php">Change Password</a></div>
<div class="about_line"><img src="images/about_line.jpg" /></div>

<div class="aboutus_content_line1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow1.jpg" />&nbsp;&nbsp;&nbsp;<a href="logout.php">&nbsp;Logout</a></div>
<div class="aboutus_leftmenu1"><img src="images/internal_bg3.jpg" /></div>

</div>

<div class="left_menu_left1"><img src="images/icon.jpg" class="left_image" hspace="5" />Impetusit News </div>
