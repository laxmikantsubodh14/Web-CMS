...
if($_REQUEST['del']=='yes')
{
            $select_picture = "select Image, URL  from synergy_menu2  where MenuID='$_REQUEST[id]'";
			...
			$sqlDel="delete from synergy_menu2 where MenuID='$_REQUEST[id]'";
...
if(is_post_back()) {
	...
	if(is_array($bb)) {
		...
		if($_REQUEST['Delete']!='') {		
			...
			$select_picture = "select Image, URL  from synergy_menu2  where MenuID in ($bbb)";
            $resultimg=$contact->Execute($select_picture) or die($contact->ErrorMsg());
			...
			while (!$resultimg->EOF) 
	       {
			...
			$sqlDel="delete from synergy_menu2 where MenuID in ($bbb)";
			$resultDel = $contact->Execute($sqlDel) or die($contact->ErrorMsg());
			...
			$sql = "update  synergy_menu2  set IsActive= 'Y' where MenuID in ($bbb)";
			...
			$sql = "update synergy_menu2 set IsActive= 'N' where MenuID in ($bbb)";
			$resultsql = $contact->Execute($sql) or die($contact->ErrorMsg());
...
$columns = "select * ";
$sql = " from  synergy_menu2 where ParentID='0'";
...
function showsubmenu($id)
    {
	  global $contact;
	 $SqlSelectsubMenu="select * from synergy_menu2 where ParentID='$id' order by Ordering";
...
<td align="center" nowrap><a href="add_menu.php?MenuID=<?php echo $ResultSubSelectMenu->fields['MenuID'];?>"><img src="images/icon-edit.gif" border="0" alt="Edit" /></a>&nbsp;|&nbsp;<a href="menu_view.php?del=yes&id=<?php echo $ResultSubSelectMenu->fields['MenuID'];?>"><img src="images/icon-delete.gif" border="0" alt="Delete" /></a> </td>
...
<!--<tr>
	<td><table width="80%" height="25" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td width="2%" nowrap="nowrap"><a  href="pages_view.php">Banner Pages  </a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="location_view.php">Banner Location </a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="banner_view.php">Banners </a></td>
...
<tr><td height="250" valign="top"><br>
       <div align="right"> <a href="add_menu2.php">Add Menu</a></div>
...
<td align="center" nowrap><a href="add_menu2.php?MenuID=<?php echo $result->fields['MenuID'];?>"><img src="images/icon-edit.gif" border="0" alt="Edit" /></a>&nbsp;|&nbsp;<a href="menu_list2.php?del=yes&id=<?php echo $result->fields['MenuID'];?>"><img src="images/icon-delete.gif" border="0" alt="Delete" /></a> </td>
